    ...
    <div className="fixed inset-0 flex items-center justify-center bg-black  opacity-80 backdrop-blur-sm z-50">
      ...
      >
        ...
        <form className="mt-4 space-y-4">
          ...
          <input type="email" placeholder="Email" className="w-full p-3 border rounded-lg outline-none" required />
          <input type="password" placeholder="Password" className="w-full p-3 border rounded-lg outline-none" required />
